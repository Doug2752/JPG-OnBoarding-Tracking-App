// ── INSTRUCTIONS PANEL — InstructionsPanel.js ────────────────
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { fontSize: "15px", fontWeight: "700", color: DARK, letterSpacing: "2px" } },
            "INSTRUCTIONS"
          ),
          React.createElement(
            "div",
            { style: { fontSize: "10px", color: "#888", letterSpacing: "1px", marginTop: "2px" } },
            "14-Day Initial Onboarding Tracking Log"
          )
        ),
        React.createElement(
          "button",
      ...
      sections.map(function ({ title, color, text }) {
        return React.createElement(
          "div",
          { key: title, style: { marginBottom: "18px" } },
          React.createElement(
            "div",
            {
              style: {
          ...
          text.split("\n\n").map(function (p, i) {
            return React.createElement(
              "p",
              { key: i, style: { fontSize: "12px", color: MID, lineHeight: "1.75", marginBottom: "6px" } },
              p
            );
          })
        );
